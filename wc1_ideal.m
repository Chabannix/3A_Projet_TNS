function [Y,Wc1_ideal_num,Wc1_ideal_denom] = wc1_ideal(X, S, Fs, Sigmab, p)
...
Wc1_ideal_num = numerateurWnc*K^2*conv(Gplus_num,A_causal);
Wc1_ideal_denom = conv(A1_causal,Gplus_denom);
Y = real(filter(Wc1_ideal_num, Wc1_ideal_denom, X));
